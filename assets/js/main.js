(function($) {
    ...
    $(".main-banner").mousemove(function(e) {
        ...
        var newy = y - wy / 2;
        $(
            ".main-banner-animation-image img:nth-child(1), .main-banner-animation-image img:nth-child(3), .main-banner-animation-image img:nth-child(5), .main-banner-animation-image img:nth-child(7), .main-banner-animation-image img:nth-child(9), .main-banner-animation-image img:nth-child(11), .main-banner-image"
        ).each(function() {
    ...
    $(".main-banner").mousemove(function(e) {
        ...
        var newx = x - wx / 2;
        $(
            ".main-banner-animation-image img:nth-child(2), .main-banner-animation-image img:nth-child(4), .main-banner-animation-image img:nth-child(6), .main-banner-animation-image img:nth-child(8), .main-banner-animation-image img:nth-child(10), .main-banner-animation-image img:nth-child(12)"
        ).each(function() {
            var speed = $(this).attr("data-speed");
            if ($(this).attr("data-revert")) speed *= -0.4;
    ...
    $(".banner-section").mousemove(function(e) {
        ...
        var newy = y - wy / 2;
        $(
            ".banner-animation-image img:nth-child(1), .banner-animation-image img:nth-child(3), .banner-animation-image img:nth-child(5), .banner-animation-image img:nth-child(7), .banner-animation-image img:nth-child(9), .banner-animation-image img:nth-child(11), .banner-image"
        ).each(function() {
            var speed = $(this).attr("data-speed");
            if ($(this).attr("data-revert")) speed *= -0.4;
            TweenMax.to($(this), 1, { x: 1 - newx * speed, y: 1 - newy * speed });
    ...
    $(".banner-section").mousemove(function(e) {
        ...
        var newx = x - wx / 2;
        $(
            ".banner-animation-image img:nth-child(2), .banner-animation-image img:nth-child(4), .banner-animation-image img:nth-child(6), .banner-animation-image img:nth-child(8), .banner-animation-image img:nth-child(10), .banner-animation-image img:nth-child(12)"
        ).each(function() {
            var speed = $(this).attr("data-speed");
            if ($(this).attr("data-revert")) speed *= -0.4;
            TweenMax.to($(this), 1, { y: 1 - newx * speed, x: 1 - newy * speed });
    ...
    $(".main-banner-area").mousemove(function(e) {
        ...
        $("img").each(function() {
            var speed = $(this).attr("data-speed");
            if ($(this).attr("data-revert")) speed *= -0.8;
            TweenMax.to($(this), 1, { x: 1 - newx * speed, y: 1 - newy * speed });
        });
    });
...
function onClickActive() {
    ...
    if (document.getElementById("btn-aboutus").getAttribute("href") == "#1") {
        document.getElementById("aboutus").classList.add("active");
        document.getElementById("fieldOfActivity").classList.remove("active");
